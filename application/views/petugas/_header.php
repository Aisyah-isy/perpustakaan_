...
<!-- =========================================================
* Sneat - Bootstrap 5 HTML petugas Template - Pro | v1.0.0
==============================================================

* Product Page: https://themeselection.com/products/sneat-bootstrap-html-petugas-template/
		...
		<div class="layout-container">
			...
			<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-item <?php if ($menu == '') {
												echo 'active';
											} ?>">
					...
					<li class="menu-item <?php if ($menu == 'peminjaman') {
						...
						<a href="<?= base_url('petugas/peminjaman') ?>" class="menu-link">
					...
					<li class="menu-item <?php if ($menu == 'ulasan') {
						...
						<a href="<?= base_url('petugas/ulasan') ?>" class="menu-link">
							<i class="menu-icon tf-icons bx bx-comment"></i>
							<div data-i18n="Analytics">Ulasan</div>
						</a>
					</li>
					<li class="menu-item <?php if ($menu == 'laporan') {
												echo 'active';
											} ?>">
				...
				<nav
					...
					<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
						<div class="navbar-nav align-items-center">
							<div class="nav-item mt-3 align-items-center">
								<p>PERPUS SIE | <?= $title; ?></p>
							</div>
						</div>
