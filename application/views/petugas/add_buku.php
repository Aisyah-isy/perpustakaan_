	...
	<div class="card-header justify-content-between align-items-center">
		<div class="row">
			...
			<div class="col-6 text-end">
				<a class="btn btn-sm mb-3 btn-success" href="<?= base_url('petugas/buku') ?>"><i class="bx bx-back me-1"></i> Kembali </a>
			</div>
		</div>
	</div>
	<div class="card-body">
		<form action="<?= base_url('petugas/add_buku') ?>" method="post" enctype="multipart/form-data">
			<div class="row">
				<div class="mb-0">
			...
			<div class="row g-2 mt-2">
				...
				<div class="col mb-0">
					...
					<input required type="number" name="tahun_terbit" id="nameLarge" class="form-control" placeholder="Tahun Terbit" />
				</div>
			</div>
			<div class="row g-2 mt-2">
				<div class="col mb-0">
				...
				<div class="col mb-0">
					...
					<input required type="number" name="stok" id="nameLarge" class="form-control" placeholder="Stok" />
				</div>
			</div>
			<div class="row">
				<div class="mb-0">
