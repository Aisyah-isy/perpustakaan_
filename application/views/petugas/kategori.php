...
<div class="card">
	...
	<div class="card-body">
		<form action="<?= base_url('petugas/add_kategori') ?>" method="post">
			<div class="row mb-3">
					...
					foreach ($kategori as $u) { ?>
						<tr>
							...
							<td>
								...
								<a class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus data kategori?')" href="<?= base_url('petugas/delete_kategori/' . $u['kategori_id']) ?>"><i class="bx bx-trash me-1"></i> </a>
							</td>
							<!-- Large Modal -->
