				...
				<div class="col-lg-6 col-md-6">
					<div class="login_part_text text-center">
						<div class="login_part_text_iner">
							<h2>New to PERPUS SIE?</h2>
							<p>Buat akun terlebih dahulu untuk memulai menjelajahi jendela duni bersama PERPUS SIE</p>
							<a href="<?= base_url('auth/register') ?>" class="btn_3">Create an Account</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6 col-md-6">
					<div class="login_part_form">
						<div class="login_part_form_iner">
							<h3>Welcome Back ! <br>
								Log in untuk masuk ke akunmu!</h3>
							<form class="row contact_form" action="<?= base_url('auth/proccess_login') ?>" method="post" novalidate="novalidate">
