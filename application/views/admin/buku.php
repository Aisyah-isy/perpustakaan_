...
<div class="card">
	...
	<div class="card-body">
		<a class="btn btn-sm mb-3 btn-primary" href="<?= base_url('admin/add_bukuC') ?>"><i class="bx bx-plus me-1"></i> Add buku </a>
					...
					foreach ($buku as $u) { ?>
						<tr>
							...
							<td>
								...
								<a class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus data buku?')" href="<?= base_url('admin/delete_buku/' . $u['buku_id'] . '/' . $u['cover']) ?>"><i class="bx bx-trash me-1"></i> </a>
							</td>
							<!-- Large Modal -->
