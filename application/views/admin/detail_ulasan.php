				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-2 text-end">
							<a class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus komentar ini?')" href="<?= base_url('admin/delete_ulasan/' . $u['ulasan_id'].'/' . $u['buku_id']) ?>"><i class="bx bx-trash me-1"></i> </a>
						</div>
					</div>
					<p class="card-text">
						<?= $u['ulasan'] ?>
