									...
									<div class="single_product_item">
										...
										<div class="single_product_text">
											...
											<?php if ($this->Model->cek_koleksi($this->session->userdata('user_id'), $b['buku_id']) != NULL) { ?>
												<a  onclick="return confirm('Hapus buku <?= $b['judul'] ?> dari favorite-mu?')" href="<?= base_url('peminjam/delete_koleksi/' . $b['koleksi_id']) ?>" class="add_cart"><i class="ti-trash"></i></a>
											<?php } ?>
										</div>
									</div>
								</div>
