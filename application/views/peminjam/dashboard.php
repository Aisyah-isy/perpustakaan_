					...
					<div class="single_banner_slider">
						<div class="row">
							<div class="banner_img d-none d-lg-block">
								<img src="<?= base_url('assets/images/') ?>dash1.jpg" alt="">
							</div>
							<div class="col-lg-5 col-md-8">
								<div class="banner_text">
									<div class="banner_text_iner">
										<h1>Perpus SIE</h1>
										<p>Buku adalah jendela dunia. Kunjungi Perpus SIE untuk eksplorasi buku kesukaanmu! Bersama Perpus SIE membaca lebih Menyenangkan</p>
										<a href="<?= base_url('peminjam/buku') ?>" class="btn_2">Lihat buku</a>
									</div>
								</div>
							</div>
						</div>
